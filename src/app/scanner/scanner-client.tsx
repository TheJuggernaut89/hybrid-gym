    ...
    <div className="space-y-3">
      ...
      {!online ? (
        <div className="flex items-start gap-2 border border-fight bg-fight/10 p-3">
          ...
          <p className="font-mono text-meta leading-relaxed text-fight">
      ...
      {phase === 'capture' && (
              ...
              <div className="relative aspect-[3/4] bg-black">
                ...
                {state === 'live' ? (
                  ...
                  <div className="absolute inset-0">
                    ...
                    <p className="absolute inset-x-6 bottom-6 font-mono text-micro uppercase leading-relaxed text-faint">
                      {state === 'starting'
                        ? 'Opening camera…'
        ...
        {phase === 'analyzing' && (
          ...
          >
            ...
            <p className="mt-1 font-mono text-meta tracking-[0.2em] text-dim">
              READING TELEMETRY
            </p>
          </motion.div>
        )}
        ...
        {phase === 'review' && (
          ...
          >
            ...
            {error ? (
              <p className="border-l-2 border-fight pl-2 font-mono text-meta text-fight">{error}</p>
            ) : null}
        ...
        {phase === 'saved' && (
          ...
          >
            ...
            <p className="mt-2 font-mono text-data leading-relaxed text-dim">{saveNote}</p>
  ...
  return (
    <Panel>
      ...
      <div className="border-t border-edge px-3 py-2">
        <p className="font-mono text-micro leading-relaxed text-dim">

  ...
  if (phase === 'saved') {
    return (
      <Panel>
        ...
        <p className="p-3 font-sans text-read text-phosphor">{note}</p>
      </Panel>
    );
  }
      ...
      <div className="space-y-3">
        <Panel>
          ...
          <div className="border-t border-edge px-3 py-2">
            <p className="font-sans text-read text-dim">{data.portion_note}</p>
  ...
  if (phase === 'confirm' || phase === 'estimating') {
    return (
      <section className="border border-edge bg-surface">
        ...
        />
        {note ? (
          <p className="border-t border-edge px-3 py-2 font-sans text-read text-dim">{note}</p>
        ) : null}
        <div className="grid grid-cols-2 gap-px bg-edge">
          <button
            type="button"

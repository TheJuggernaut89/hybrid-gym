    ...
    return (
      <div className="space-y-3">
        <section className="border border-engage bg-surface">
          ...
          <p className="px-3 py-2.5 font-mono text-read leading-relaxed text-phosphor">{note}</p>
        </section>
        <button
          type="button"
          onClick={() => {
      ...
      {type ? (
        <>
          ...
          <section className="border border-edge bg-surface">
            ...
            {scanNote ? (
              <p className="border-b border-edge px-3 py-2 font-mono text-micro leading-relaxed text-engage">
                {scanNote}
              </p>
            ) : null}
          ...
          <section className="border border-edge bg-surface">
            ...
            <div className="px-3 py-3">
              <input
                ...
                className="h-11 w-full accent-gold [touch-action:manipulation]"
              />
              <p className="font-mono text-data leading-relaxed text-dim">{anchor.feel}</p>
          ...
          <section className="border border-edge bg-surface">
            ...
            <p className="border-t border-edge px-3 py-2 font-mono text-micro leading-relaxed text-dim">
              Duration x effort. The same unit for every kind of training, so a lift and a
              class are compared on what they cost you, not on calories.
            </p>
            {note && !done ? (
              <>
                <HazardBar />
                <p className="px-3 py-2 font-mono text-data leading-relaxed text-phosphor">
                  {note}
                </p>
              </>
            ) : null}
